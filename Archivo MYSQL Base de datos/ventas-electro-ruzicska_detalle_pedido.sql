...
CREATE TABLE `detalle_pedido` (
  ...
  CONSTRAINT `detalle_pedido_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos_proveedor` (`id_pedido`),
...
INSERT INTO `detalle_pedido` VALUES (4,1,15,1),(5,2,19,2),(6,3,24,1),(7,3,29,1);
