...
CREATE TABLE `pedidos_proveedor` (
  ...
  CONSTRAINT `pedidos_proveedor_ibfk_1` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id_proveedor`)
...
INSERT INTO `pedidos_proveedor` VALUES (1,1,'2026-02-01','Pendiente'),(2,2,'2026-02-02','Pendiente'),(3,3,'2026-02-03','Recibido'),(4,4,'2026-02-04','Pendiente'),(5,6,'2026-02-05','Recibido');
